...
|
*/
$config['layout_web_folder'] = 'layout';
$config['layout_default_template']         = 'main_template';
$config['layout_default_title']            = 'Trumpeten';
$config['layout_default_charset']          = $this->item('charset');
$config['layout_default_content_section']  = 'content';
$config['layout_basic_css']  = array('bootstrap.css');
